...
export class MsgClientImpl {
    ...
    SubmitScavenge(request) {
        ...
        const promise = this.rpc.request("lukeajtodd.scavenge.scavenge.Msg", "SubmitScavenge", data);
    ...
    CommitSolution(request) {
        ...
        const promise = this.rpc.request("lukeajtodd.scavenge.scavenge.Msg", "CommitSolution", data);
    ...
    RevealSolution(request) {
        ...
        const promise = this.rpc.request("lukeajtodd.scavenge.scavenge.Msg", "RevealSolution", data);
