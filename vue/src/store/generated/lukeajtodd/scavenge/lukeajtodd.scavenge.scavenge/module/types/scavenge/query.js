...
export const protobufPackage = "lukeajtodd.scavenge.scavenge";
...
export class QueryClientImpl {
    ...
    Params(request) {
        ...
        const promise = this.rpc.request("lukeajtodd.scavenge.scavenge.Query", "Params", data);
        return promise.then((data) => QueryParamsResponse.decode(new Reader(data)));
    }
    Scavenge(request) {
        const data = QueryGetScavengeRequest.encode(request).finish();
        const promise = this.rpc.request("lukeajtodd.scavenge.scavenge.Query", "Scavenge", data);
    ...
    ScavengeAll(request) {
        ...
        const promise = this.rpc.request("lukeajtodd.scavenge.scavenge.Query", "ScavengeAll", data);
    ...
    Commit(request) {
        ...
        const promise = this.rpc.request("lukeajtodd.scavenge.scavenge.Query", "Commit", data);
    ...
    CommitAll(request) {
        ...
        const promise = this.rpc.request("lukeajtodd.scavenge.scavenge.Query", "CommitAll", data);
