...
func init() {
	proto.RegisterType((*MsgSubmitScavenge)(nil), "lukeajtodd.scavenge.scavenge.MsgSubmitScavenge")
	proto.RegisterType((*MsgSubmitScavengeResponse)(nil), "lukeajtodd.scavenge.scavenge.MsgSubmitScavengeResponse")
	proto.RegisterType((*MsgCommitSolution)(nil), "lukeajtodd.scavenge.scavenge.MsgCommitSolution")
	proto.RegisterType((*MsgCommitSolutionResponse)(nil), "lukeajtodd.scavenge.scavenge.MsgCommitSolutionResponse")
	proto.RegisterType((*MsgRevealSolution)(nil), "lukeajtodd.scavenge.scavenge.MsgRevealSolution")
	proto.RegisterType((*MsgRevealSolutionResponse)(nil), "lukeajtodd.scavenge.scavenge.MsgRevealSolutionResponse")
}
...
var fileDescriptor_62ec6f1544538068 = []byte{
	...
	0x4b, 0xcd, 0x4b, 0x4f, 0xd5, 0x2f, 0xa9, 0xd0, 0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17, 0x92, 0xc9,
	0x29, 0xcd, 0x4e, 0x4d, 0xcc, 0x2a, 0xc9, 0x4f, 0x49, 0xd1, 0x83, 0xc9, 0xc2, 0x19, 0x4a, 0xdd,
	...
	0x00, 0xff, 0xff, 0x24, 0x8e, 0x5d, 0xe8, 0xba, 0x03, 0x00, 0x00,
}
...
func (c *msgClient) SubmitScavenge(ctx context.Context, in *MsgSubmitScavenge, opts ...grpc.CallOption) (*MsgSubmitScavengeResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/lukeajtodd.scavenge.scavenge.Msg/SubmitScavenge", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) CommitSolution(ctx context.Context, in *MsgCommitSolution, opts ...grpc.CallOption) (*MsgCommitSolutionResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/lukeajtodd.scavenge.scavenge.Msg/CommitSolution", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) RevealSolution(ctx context.Context, in *MsgRevealSolution, opts ...grpc.CallOption) (*MsgRevealSolutionResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/lukeajtodd.scavenge.scavenge.Msg/RevealSolution", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_SubmitScavenge_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/lukeajtodd.scavenge.scavenge.Msg/SubmitScavenge",
	}
...
func _Msg_CommitSolution_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/lukeajtodd.scavenge.scavenge.Msg/CommitSolution",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_RevealSolution_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/lukeajtodd.scavenge.scavenge.Msg/RevealSolution",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "lukeajtodd.scavenge.scavenge.Msg",
